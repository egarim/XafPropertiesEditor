...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafPropertiesEditorBlazorApplication>();
            builder.Modules
                .AddCloningXpo()
                ...
                .Add<XafPropertiesEditor.Module.XafPropertiesEditorModule>()
            	.Add<XafPropertiesEditorBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XafPropertiesEditor.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XafPropertiesEditor.Module.BusinessObjects.ApplicationUserLoginInfo);
